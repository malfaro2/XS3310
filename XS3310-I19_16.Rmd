...
# Detalles del proyecto de Shiny

* Asignación de grupos: si alguien quiere trabajar por su cuenta, por favor tomen en consideración que la evaluación se hará usando los mismos rubros de calidad.

* Grupos de 5 personas (la lista está en Mediación Virtual)

* Trabajo consiste en diseñar, programar y presentar un app de Shiny que sirva para enseñar Estadística Bayesiana.

    - Opción A: Tomar el código de alguna aplicación hecha el año pasado y arreglar código incorrecto (de ser necesario), además de diseñar y presentar una explicación de cómo usarla, con una actividad didáctica que acompañe el app.

    - Opción B: Diseñar, programar y presentar una actividad didáctica para la enseñanza de Estadística Bayesiana desde cero.

* Fecha de entrega de las propuestas: 25 de junio en clase. La propuesta puede ser un dibujo a mano o sketch en donde se especifique el objetivo del app.

* Fecha de presentación: 5 de julio de 7am a 9am.
